...
KeystonePolaris.Changelog["3.0"] = {
    ...
    important = {
        ...
        ["enUS"] = {
            ...
            .. "[Keystone Percentage Helper] is now [Keystone Polaris], aligning with the Mythic+ Swiss‑army‑knife vision built with the community. \n\n"
        ...
        ["frFR"] = {
            ...
            .. "[Keystone Percentage Helper] devient [Keystone Polaris], conformément à la vision du couteau suisse Mythique+ imaginée et construite avec la communauté. \n\n"
