...
L["KPH_GR_HEADER"] = "Group Reminder"
...
L["KPH_GR_NOTIFICATIONS"] = "Notifications"
L["KPH_GR_SUPPRESS_TOAST"] = "Suppress Blizzard quick-join toast"
L["KPH_GR_SUPPRESS_TOAST_DESC"] = "Hide the default Blizzard popup that appears at the bottom of the screen when invited."
L["KPH_GR_SHOW_POPUP"] = "Show popup"
L["KPH_GR_SHOW_POPUP_DESC"] = "Display the reminder window in the center of the screen."
L["KPH_GR_SHOW_CHAT"] = "Show chat message"
L["KPH_GR_SHOW_CHAT_DESC"] = "Print the reminder details in the chat window."
L["KPH_GR_TEST_CURRENT_SEASON"] = "Simulate current season acceptance"
L["KPH_GR_TEST_CURRENT_SEASON_DESC"] = "Show the group reminder using a dungeon from the current season."
L["KPH_GR_CONTENT"] = "Content"
