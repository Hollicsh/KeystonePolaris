...
L["ROLES_ENABLED_DESC"] = "Выбрать, какие роли смогут использовать кнопку информирования группы" -- TODO: enUS@a2c29d368be3
L["ENABLE"] = "Включить"
...
L["KPL_RM_RESET_POSITION_DESC"] = "Вернуть кнопку метки ролей в центр экрана."
