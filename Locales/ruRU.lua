...
L["MODULES_SUMMARY_ROLE_MARKER_DESC"] = "Отображает кнопку, на которую можно нажать, чтобы поставить метку на танка и целителя в Вашей группе. Нажатие необходимо, так как в 'Полночи' нельзя автоматически ставить метки рейда."
...
L["ROLES_ENABLED_DESC"] = "Выбрать, какие роли смогут использовать кнопку информирования группы"
L["ENABLE"] = "Включить"
...
L["KPL_GR_SHOW_POPUP_WHEN_FULL_LEADER"] = "Показывать всплывающее окно при заполнении группы (как лидер группы)"
L["KPL_GR_SHOW_POPUP_WHEN_FULL_LEADER_DESC"] = "Отображать окно-напоминание, когда в Вашей группе M+ наберётся 5 игроков, а Вы являетесь лидером группы."
...
-- Role Marker
L["KPL_RM_HEADER"] = "Метка ролей"
L["KPL_RM_DESC_LONG"] = "Показывает кнопку, чтобы поставить метку на танка и целителя в эпохальных подземельях и М+. Нажмите кнопку, чтобы поставить метки. Аддоны не могут ставить их автоматически в 'Полночи'."
L["KPL_RM_CLICK_REQUIRED"] = "Требуется клик: Blizzard запрещает автоматически ставить метки рейда, поэтому эта кнопка запускает защищённый макрос /tm."
L["KPL_RM_SHOW_OUTSIDE"] = "Показывать вне подземелий"
L["KPL_RM_SHOW_OUTSIDE_DESC"] = "Также показывать кнопку в открытом мире, чтобы Вы могли отметить танка и целителя перед входом в подземелье. Скрыта в Вылазках, рейдах, PvP и других подземельях, кроме М+."
L["KPL_RM_SHOW_TITLE"] = "Показывать заголовок"
L["KPL_RM_SHOW_TITLE_DESC"] = "Показывать 'Keystone Polaris - Метка ролей' над кнопкой, чтобы было ясно, что этот элемент управления от аддона."
L["KPL_RM_MARKERS"] = "Метки"
L["KPL_RM_MARKER_NONE"] = "-нет-"
L["KPL_RM_BUTTON"] = "Поставить метку на %s"
L["KPL_RM_ROLES_AND"] = "%s и %s"
L["KPL_RM_POSITION"] = "Позиция"
L["KPL_RM_RESET_POSITION"] = "Сбросить позицию"
L["KPL_RM_RESET_POSITION_DESC"] = "Вернуть кнопку метки ролей в исходное положение над полосой прогресса."
L["KPL_RM_TOOLTIP"] = "Нажмите, чтобы поставить метку на выбранные роли."
