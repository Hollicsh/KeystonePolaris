...
L["KPL_RM_DESC_LONG"] = "Показывает кнопку для отметки танка и целителя в эпохальных подземелья и М+. Нажмите кнопку, чтобы поставить метки. Аддоны не могут ставить их автоматически в 'Полночи'."
L["KPL_RM_CLICK_REQUIRED"] = "Требуется клик: Blizzard защищает метки рейда, поэтому эта кнопка запускает защищённый макрос /tm."
...
L["KPL_RM_TOOLTIP"] = "Нажмите, чтобы отметить выбранные роли."
