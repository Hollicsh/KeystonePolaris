...
L["MODULES_SUMMARY_ROLE_MARKER_DESC"] = "Отображает кнопку, на которую можно нажать, чтобы отметить танка и целителя в Вашей группе. Нажатие необходимо, так как 'Полночь' защищает метки рейда."
