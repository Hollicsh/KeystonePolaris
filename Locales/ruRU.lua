...
L["MOB_PERCENTAGES_API_FOUND"] = "API прогресса юнитов для Mythic+ от Blizzard доступен. Процентное соотношение мобов будет определяться на основе данных подземелья в реальном времени."
