...
L["IMPORT_DIFFERENT_DUNGEON_SIMPLE"] = "This import is for %s."
L["IMPORT_MDT_DIFFERENT_DUNGEON"] = "Imported MDT route for %s. Opening options for that dungeon."
L["IMPORT_MDT_DIFFERENT_DUNGEON_SIMPLE"] = "This MDT route is for %s."
