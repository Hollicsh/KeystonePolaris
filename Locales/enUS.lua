...
L["INFORM_GROUP_DESC"] = "Send a message to chat when percentage is missing"
...
L["MOB_INDICATOR_INFO"] = "• |cff00ff00Mob Indicators|r: Marks nameplates to show which enemies are included in your current MDT route pull."
