...
L["REMIX"] = "Remix"
L["CURRENT_SEASON_ENDS_SOON"] = "Current season ends in less than one month."
L["SEASON_ENDS_IN_ONE_MONTH"] = "Season ends in less than one month."
L["SEASON_ENDS_IN_TWO_WEEKS"] = "Season ends in less than two weeks."
L["SEASON_ENDS_IN_DAYS"] = "Season ends in %d day(s)."
L["SEASON_STARTS_IN_ONE_MONTH"] = "Next season starts in less than one month."
L["SEASON_STARTS_IN_TWO_WEEKS"] = "Next season starts in less than two weeks."
L["SEASON_STARTS_IN_DAYS"] = "Next season starts in %d day(s)."
