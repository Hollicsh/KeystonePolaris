...
L["KPL_RM_LOCK_POSITION"] = "Lock position"
L["KPL_RM_LOCK_POSITION_DESC"] = "When unlocked, the button stays visible so you can drag it. Lock it again to mark with a click."
...
L["KPL_RM_UNLOCKED_HINT"] = "Position unlocked: drag to move, then lock in options to mark."
