...
L["MODULES_SUMMARY_ROLE_MARKER_DESC"] = "Shows a clickable button to mark the tank and healer in your party. A click is required because Midnight protects raid markers."
...
L["PREVIEW_SCENARIO"] = "Preview Scenario"
L["PREVIEW_IDLE"] = "Mid-dungeon (idle)"
L["PREVIEW_PULLING"] = "Mid-dungeon (pulling)"
L["PREVIEW_PROJECTED"] = "Projected completes section"
L["PREVIEW_SECTION_DONE"] = "Section complete"
L["PREVIEW_MISSING"] = "Missing (boss killed)"
L["PREVIEW_ALMOST_DONE"] = "Almost done (pulling)"
L["PREVIEW_DUNGEON_DONE"] = "Dungeon complete"
L["PREVIEW_MILESTONE_LABEL"] = "Gates"
L["PROGRESS_BAR"] = "Progress Bar"
L["PROGRESS_BAR_ENABLED"] = "Enable Progress Bar"
L["PROGRESS_BAR_ENABLED_DESC"] = "Show a visual progress bar for enemy forces percentage."
L["PROGRESS_BAR_WIDTH"] = "Width"
L["PROGRESS_BAR_HEIGHT"] = "Height"
L["PROGRESS_BAR_DIRECTION"] = "Fill Direction"
L["PROGRESS_BAR_DIRECTION_LTR"] = "Left to Right"
L["PROGRESS_BAR_DIRECTION_RTL"] = "Right to Left"
L["PROGRESS_BAR_TEXTURE"] = "Bar Texture"
L["PROGRESS_BAR_USE_GRADIENT"] = "Use Gradient"
L["PROGRESS_BAR_USE_GRADIENT_DESC"] = "Blend completed sections between a start color and an end color across the full bar. In-progress and missing sections keep their dedicated colors."
L["PROGRESS_BAR_GRADIENT_START_COLOR"] = "Gradient Start"
L["PROGRESS_BAR_GRADIENT_END_COLOR"] = "Gradient End"
L["PROGRESS_BAR_OVERRIDE_COLORS"] = "Override Colors"
L["PROGRESS_BAR_OVERRIDE_COLORS_DESC"] = "Use custom colors for the progress bar instead of the text display colors."
L["PROGRESS_BAR_COMPLETED_COLOR"] = "Completed"
L["PROGRESS_BAR_IN_PROGRESS_COLOR"] = "In Progress"
L["PROGRESS_BAR_MISSING_COLOR"] = "Missing"
L["PROGRESS_BAR_BG_COLOR"] = "Background Color"
L["PROGRESS_BAR_BG_ALPHA"] = "Background Opacity"
L["PROGRESS_BAR_BORDER_STYLE"] = "Border Style"
L["PROGRESS_BAR_BORDER_NONE"] = "None"
L["PROGRESS_BAR_BORDER_SOLID"] = "Solid"
L["PROGRESS_BAR_BORDER_LSM"] = "Texture"
L["PROGRESS_BAR_BORDER_TEXTURE"] = "Border Texture"
L["PROGRESS_BAR_BORDER_COLOR"] = "Border Color"
L["PROGRESS_BAR_BORDER_SIZE"] = "Border Size"
L["PROGRESS_BAR_TICK_COLOR"] = "Tick Color"
L["PROGRESS_BAR_TICK_WIDTH"] = "Tick Width"
L["PROGRESS_BAR_TICK_OVERFLOW"] = "Tick Overflow"
L["PROGRESS_BAR_TICK_OVERFLOW_DESC"] = "How far tick marks extend beyond the bar edges."
L["PROGRESS_BAR_SHOW_MILESTONE_TICKS"] = "Show Milestone Ticks"
L["PROGRESS_BAR_SHOW_MILESTONE_TICKS_DESC"] = "Display thinner tick marks at configured milestone thresholds on the progress bar."
L["PROGRESS_BAR_MILESTONE_TICK_COLOR"] = "Milestone Tick Color"
L["PROGRESS_BAR_MILESTONE_TICK_WIDTH"] = "Milestone Tick Width"
L["PROGRESS_BAR_MILESTONE_TRIGGER"] = "Trigger: %s"
L["PROGRESS_BAR_SHOW_CALLOUT"] = "Show Callout"
L["PROGRESS_BAR_SHOW_CALLOUT_DESC"] = "Display a callout above or below the bar showing the current section's target."
L["PROGRESS_BAR_CALLOUT_POSITION"] = "Callout Position"
L["PROGRESS_BAR_CALLOUT_ABOVE"] = "Above"
L["PROGRESS_BAR_CALLOUT_BELOW"] = "Below"
L["PROGRESS_BAR_CALLOUT_FONT"] = "Callout Font"
L["PROGRESS_BAR_CALLOUT_FONT_SIZE"] = "Callout Font Size"
L["PROGRESS_BAR_CALLOUT_TEXT_COLOR"] = "Callout Text Color"
L["PROGRESS_BAR_CALLOUT_BG_COLOR"] = "Callout Background"
L["PROGRESS_BAR_CALLOUT_FORMAT"] = "%.2f%% • %s"
L["PROGRESS_BAR_THRESHOLD"] = "Threshold: %.2f%%"
L["PROGRESS_BAR_COUNT"] = "Count: %d"
...
L["ROLES_ENABLED_DESC"] = "Select which roles can use the Inform Group button"
L["ENABLE"] = "Enable"
...
L["SHOW_INFORM_GROUP_BUTTON"] = "Inform Group Button"
L["SHOW_INFORM_GROUP_BUTTON_DESC"] = "Show the Inform Group button on the addon's display"
...
L["MILESTONES_DESC"] = "Create custom checkpoints such as \"10% before reaching XXX\" with optional Zone/Subzone triggers."
L["MILESTONE"] = "Milestone"
L["MILESTONE_ADD"] = "Add Milestone"
L["MILESTONE_REMOVE"] = "Remove Milestone"
L["MILESTONE_REMOVE_CONFIRM"] = "Are you sure you want to remove this milestone?"
L["MILESTONE_LABEL"] = "Label"
L["MILESTONE_THRESHOLD"] = "Total Percentage"
L["MILESTONE_TRIGGER_TYPE"] = "Trigger Type"
L["MILESTONE_TRIGGER_NONE"] = "None"
L["MILESTONE_TRIGGER_ZONE"] = "Zone"
L["MILESTONE_TRIGGER_SUBZONE"] = "Subzone"
L["MILESTONE_MATCH_TEXT"] = "Match Text"
L["MILESTONE_INFORM_SUFFIX"] = "Inform Text After Percentage"
L["MILESTONE_INFORM_SUFFIX_DESC"] = "Optional text appended after the percentage for this milestone's inform message."
L["MILESTONE_CAPTURE_ZONE"] = "Capture Current Zone"
L["MILESTONE_CAPTURE_SUBZONE"] = "Capture Current Subzone"
L["MILESTONE_CAPTURE_FALLBACK_WARN"] = "Could not resolve a zone ID; saved localized text instead (not portable across clients)."
L["MILESTONE_PERCENTAGE_DONE"] = "Milestone Percentage Done"
L["FONT"] = "Font"
L["FONT_SIZE"] = "Font Size"
L["FONT_SIZE_DESC"] = "Adjust the size of the text"
L["FONT_FLAGS"] = "Font Flags"
L["FONT_FLAGS_DESC"] = "Rendering options applied to all text that uses the main font."
L["FONT_FLAG_NONE"] = "None"
L["FONT_FLAG_SLUG"] = "Slug"
L["FONT_FLAG_OUTLINE_SLUG"] = "Outline + Slug"
L["FONT_FLAG_MONOCHROME"] = "Monochrome"
L["FONT_FLAG_OUTLINE"] = "Outline"
L["FONT_FLAG_THICKOUTLINE"] = "Thick Outline"
L["FONT_FLAG_OUTLINE_MONOCHROME"] = "Outline + Monochrome"
L["FONT_FLAG_THICKOUTLINE_MONOCHROME"] = "Thick Outline + Monochrome"
...
L["IN_PROGRESS_COLOR_DESC"] = "Color for section values that are not yet complete."
L["MISSING"] = "Missing"
L["MISSING_COLOR_DESC"] = "Color for values when a boss was killed before reaching the required percentage."
L["FINISHED_COLOR"] = "Done"
L["FINISHED_COLOR_DESC"] = "Color for values when a section's required percentage has been reached."
L["VALIDATE"] = "Save"
L["CANCEL"] = "Cancel"
...
L["ADDON_LOADED_MSG"] = "loaded, type /kpl to open settings, or /kpl help to show the list of available commands."
...
L["SHOW_REQUIRED_PREFIX_DESC"] = "When the base value is numeric (e.g., 12.34%), prefix it with a label (e.g., 'Required:'). No prefix is added when the section or dungeon is complete."
L["PREFIX"] = "Prefix"
...
L["SHOW_MILESTONES"] = "Enable milestones"
L["SHOW_MILESTONES_DESC"] = "Show milestone supplementary text and milestone-specific inform logic."
L["MILESTONE_DISPLAY_LABEL_DESC"] = "Label displayed before milestone text.\n\nClear the field to reset to the default value."
...
L["FONT_ALIGN"] = "Font Alignment"
L["FONT_ALIGN_DESC"] = "Horizontal alignment for the display text."
L["PREFIX_COLOR_DESC"] = "Color applied to labels/prefixes (Required, Current, Pull). Milestone prefix uses this unless Custom Milestone prefix color is enabled."
L["CUSTOM_MILESTONE_PREFIX_COLOR"] = "Custom Milestone Prefix Color"
L["CUSTOM_MILESTONE_PREFIX_COLOR_DESC"] = "Use a dedicated prefix color for milestone supplementary text instead of the global Prefix color above."
L["MILESTONE_PREFIX_COLOR"] = "Prefix Color"
L["MILESTONE_PREFIX_COLOR_DESC"] = "Color applied to the milestone supplementary text prefix label."
L["TEXT_OPACITY"] = "Text Opacity"
L["TEXT_OPACITY_DESC"] = "Controls the transparency of the display text."
L["REQUIRED_DEFAULT"] = "Required:"
L["SECTION_REQUIRED_DEFAULT"] = "Total required for section:"
L["CURRENT_DEFAULT"] = "Current:"
L["PULL_DEFAULT"] = "Pull:"
L["MILESTONE_DISPLAY_DEFAULT"] = "Milestone:"
...
L["IMPORT_DIALOG_INFO"] = "Supports Keystone Polaris import strings and MythicDungeonTools routes when MDT is loaded."
L["IMPORT_SUCCESS_OPENED"] = "Imported custom route for %s. Opening options for that dungeon."
L["IMPORT_MDT_MISSING_ADDON"] = "MDT import requires MythicDungeonTools to be loaded."
L["IMPORT_MDT_NO_PULLS"] = "MDT import failed: no pulls found in this route string."
L["IMPORT_MDT_DUNGEON_UNKNOWN"] = "MDT import failed: unable to map this route to a Keystone Polaris dungeon."
L["IMPORT_MDT_BOSS_NPCIDS_MISSING"] = "MDT import failed for %s: this dungeon is not fully supported yet."
L["IMPORT_MDT_SUCCESS"] = "Imported MDT route for %s. Updated %d boss percentages and boss order."
L["IMPORT_MDT_SUCCESS_OPENED"] = "Imported MDT route for %s. Updated %d boss percentages and boss order. Opening options for that dungeon."
L["IMPORT_MDT_INCOMPLETE"] = "MDT route import aborted: not all bosses were detected in the route. No changes were applied."

-- Profile export/import
L["PROFILE_SHARE_HEADER"] = "Share Profile"
L["PROFILE_SHARE_DESC"] = "Copy a string to share settings between accounts or machines. Use Import to load into a named profile."
L["EXPORT_PROFILE_FULL"] = "Export Full Profile"
L["EXPORT_PROFILE_FULL_DESC"] = "Export all addon settings including custom routes."
L["EXPORT_PROFILE_SETTINGS"] = "Export Settings Only"
L["EXPORT_PROFILE_SETTINGS_DESC"] = "Export display, progress bar, and module settings without custom routes."
L["IMPORT_PROFILE"] = "Import Profile"
L["IMPORT_PROFILE_DESC"] = "Import a profile string and choose a target profile name."
L["EXPORT_PROFILE_FULL_DIALOG_TEXT"] = "Copy the string below to share your full Keystone Polaris profile:"
L["EXPORT_PROFILE_SETTINGS_DIALOG_TEXT"] = "Copy the string below to share your Keystone Polaris settings (without custom routes):"
L["IMPORT_PROFILE_DIALOG_TEXT"] = "Paste a Keystone Polaris profile string below:"
L["IMPORT_PROFILE_CONFIRM_TEXT"] = "Import %s?\n\nTarget profile: %s\nActive profile: %s"
L["IMPORT_PROFILE_ACTIVATE"] = "Import and activate"
L["IMPORT_PROFILE_ONLY"] = "Import only"
L["PROFILE_SCOPE_FULL"] = "full profile"
L["PROFILE_SCOPE_SETTINGS"] = "settings only"
L["IMPORT_PROFILE_SUCCESS"] = "Profile imported into \"%s\"."
L["IMPORT_PROFILE_ERROR"] = "Invalid profile import string."
L["IMPORT_PROFILE_UNKNOWN_VERSION"] = "Unsupported profile export version."
L["IMPORT_PROFILE_EXISTS"] = "Profile \"%s\" already exists and will be overwritten."
L["IMPORT_PROFILE_USE_INTERFACE"] = "Use Profiles > Import Profile for profile strings."
...
L["MDT_FEATURE_UNAVAILABLE"] = "Disabled due to Midnight API restrictions. Will be re-enabled once Blizzard releases the new Mythic+ API."
...
L["KPL_GR_SHOW_POPUP_WHEN_FULL_LEADER"] = "Show popup when the group is full (as group leader)"
L["KPL_GR_SHOW_POPUP_WHEN_FULL_LEADER_DESC"] = "Display the reminder window when your Mythic+ group reaches 5 players and you are the group leader."
L["KPL_GR_CHAT_COMMAND_INFO"] = "Tip: use |cffffd100/kpl reminder|r to show the last group reminder again."
...
L["KPL_GR_SHOW_PLAYSTYLE"] = "Show group playstyle"
...
L["KPL_RM_SHOW_TITLE"] = "Show Title"
L["KPL_RM_SHOW_TITLE_DESC"] = "Show Keystone Polaris - Role Marker above the button so it is clear this control comes from the addon."
L["KPL_RM_MARKERS"] = "Markers"
L["KPL_RM_MARKER_NONE"] = "-none-"
L["KPL_RM_BUTTON"] = "Mark %s"
L["KPL_RM_ROLES_AND"] = "%s & %s"
L["KPL_RM_POSITION"] = "Position"
L["KPL_RM_RESET_POSITION"] = "Reset position"
L["KPL_RM_RESET_POSITION_DESC"] = "Move the Role Marker button back to the center of the screen."
L["KPL_RM_TOOLTIP"] = "Click to mark the selected roles."
