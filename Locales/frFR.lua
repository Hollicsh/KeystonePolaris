...
L["MODULES_SUMMARY_ROLE_MARKER_DESC"] = "Affiche un bouton cliquable pour marquer le tank et le healer de votre groupe. Un clic est obligatoire car Midnight protège les marqueurs."
...
L["KPL_RM_LOCK_POSITION"] = "Verrouiller la position"
L["KPL_RM_LOCK_POSITION_DESC"] = "Déverrouillé, le bouton reste visible pour le déplacer. Verrouillez-le ensuite pour marquer d'un clic."
...
L["KPL_RM_UNLOCKED_HINT"] = "Position déverrouillée : déplacez le bouton, puis verrouillez-le dans les options pour marquer."
