...
L["IMPORT_DIFFERENT_DUNGEON_SIMPLE"] = "Cet import est prévu pour %s."
L["IMPORT_MDT_DIFFERENT_DUNGEON"] = "Route MDT importée pour %s. Ouverture des options pour ce donjon."
L["IMPORT_MDT_DIFFERENT_DUNGEON_SIMPLE"] = "Cette route MDT est prévue pour %s."
