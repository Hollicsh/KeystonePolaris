...
L["REMIX"] = "Remix"
L["CURRENT_SEASON_ENDS_SOON"] = "La saison se termine dans moins d’un mois."
L["SEASON_ENDS_IN_ONE_MONTH"] = "La saison se termine dans moins d’un mois."
L["SEASON_ENDS_IN_TWO_WEEKS"] = "La saison se termine dans moins de deux semaines."
L["SEASON_ENDS_IN_DAYS"] = "La saison se termine dans %d jour(s)."
L["SEASON_STARTS_IN_ONE_MONTH"] = "La prochaine saison commence dans moins d’un mois."
L["SEASON_STARTS_IN_TWO_WEEKS"] = "La prochaine saison commence dans moins de deux semaines."
L["SEASON_STARTS_IN_DAYS"] = "La prochaine saison commence dans %d jour(s)."
